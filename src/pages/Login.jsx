...
function Login() {
  ...
  const handleUserLogin = async (event) => {
    ...
    try {
      const response = await fetch('https://back-end-layanan-pengaduan-vercel.vercel.app/api/auth/login', {
        method: 'POST',
        headers: {
  ...
  const handleUserRegister = async (event) => {
    ...
    const userData = { nama, nomor };
    try {
      const response = await fetch('https://back-end-layanan-pengaduan-vercel.vercel.app/api/auth/register', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleAdminLogin = async (event) => {
    ...
    try {
      const response = await fetch('https://back-end-layanan-pengaduan-vercel.vercel.app/api/admin/login', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  return (
    <div className="min-h-screen flex items-center justify-center w-3/5 rounded-3xl" style={{backgroundImage: `url("https://kecamatanngabang.landakkab.go.id/wp-content/uploads/2020/01/field-beautiful-terraced-green-fields-hills-terrace-farms-grass-wallpaper-678x381.jpg")`, backgroundRepeat: `no-repeat`, backgroundSize: `100% 100%`}}>
