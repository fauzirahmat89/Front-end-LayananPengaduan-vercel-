...
function AdminAspirasi() {
  ...
  useEffect(() => {
    const fetchAspirasi = async () => {
      try {
        const response = await fetch('https://back-end-layanan-pengaduan-vercel.vercel.app/api/aspirasi');
        if (!response.ok) {
  ...
  const handleUpdate = async (id) => {
    ...
    try {
      const response = await fetch('https://back-end-layanan-pengaduan-vercel.vercel.app/api/aspirasi/status', {
        method: 'PUT',
        headers: {
