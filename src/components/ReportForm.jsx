...
function ReportForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const userIdResponse = await fetch('https://back-end-layanan-pengaduan-vercel.vercel.app/api/auth/getUserId', {
        method: 'POST',
        headers: {
      ...
      if (reportType === 'pengaduan') {
        ...
        apiUrl = 'https://back-end-layanan-pengaduan-vercel.vercel.app/api/pengaduan'; // API untuk pengaduan
        ...
        apiUrl = 'https://back-end-layanan-pengaduan-vercel.vercel.app/api/aspirasi'; // API untuk aspirasi
      }
